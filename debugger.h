...
extern void             print_address_symbol(const ADDRESS64* addr, BOOLEAN with_line);
...
enum disassembly_flavor_type {disassembly_flavor_att = 0, disassembly_flavor_intel};
extern enum disassembly_flavor_type get_disassembly_flavor(void);
