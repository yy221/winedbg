...
#if HAVE_UDIS86
static enum disassembly_flavor_type disassembly_flavor = disassembly_flavor_intel;

enum disassembly_flavor_type get_disassembly_flavor(void)
{
    return disassembly_flavor;
}
#endif
...
#if HAVE_UDIS86
    else if (!strcasecmp(option, "disassembly_flavor"))
    {
        if (!val)
            dbg_printf("Option: disassembly_flavor %s\n",
                disassembly_flavor == disassembly_flavor_att ? "att":"intel");
        else if(!strcmp(val, "intel"))
            disassembly_flavor = disassembly_flavor_intel;
        else if(!strcmp(val, "att"))
            disassembly_flavor = disassembly_flavor_att;
        else
            dbg_printf("Syntax: disassembly_flavor [att|intel]\n");
